...
public class UserSession implements Closeable {
	...
	public void receiveVideoFrom(UserSession sender, String sdpOffer) throws IOException {
		System.out.println("USER {"+this.name+"}: connecting with {"+sender.getName()+"} in room {"+this.roomName+"}");
		...
		System.out.println("-----------------------------------");
		for (String key : incomingMedia.keySet()) {
...
//		}
	...
	private WebRtcEndpoint getEndpointForUser(final UserSession sender) {
		System.out.println(sender.getName()+ " "+name);
		if (sender.getName().equals(name)) {
...
//		}
	...
	public void cancelScreenFrom(final String senderName) {
		log.debug("PARTICIPANT {}: canceling video reception from {}", this.name, senderName);
		System.out.println("@!@!@!@!@:     "+senderName);
		final WebRtcEndpoint incoming = incomingMedia.remove(senderName);
//		final WebRtcEndpoint incoming = incomingMedia.get(senderName);
