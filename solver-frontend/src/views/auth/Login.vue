  ...
  <div style="overflow-x: hidden; margin-top: -56px;">
    <div class="background">
      ...
      <div class="content">
        ...
        <div>
          <a
            href="https://kauth.kakao.com/oauth/authorize?client_id=4d0b843e88238ebf6614549fce8bff85&redirect_uri=https://localhost:8080/api/v1/auth/login&response_type=code"
          >
